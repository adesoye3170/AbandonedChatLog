...
def spool_data():
    ...
    workspace_id = 'c4cd291f-d361-4d14-b21f-2a23c0495992'
    ...
    filters.by_dialog_node_id('node_4_1535173920334')\
           .by_dialog_node_id('node_6_1535175193850')\
           .by_dialog_node_id('node_1_1537359291884')\
           .by_dialog_node_id('node_2_1577111741924')\
           .by_dialog_node_id('node_24_1591025731656')\
           #.by_dialog_node_id('node_24_1591025731656')
    ...
    milestone_analysis.add_node_to_milestone("node_4_1535173920334", "Appointment scheduling start")   
    milestone_analysis.add_node_to_milestone("node_6_1535175193850", "Enter purpose of appointment")
    milestone_analysis.add_node_to_milestone("node_1_1537359291884", "Scheduling completion")
    milestone_analysis.add_node_to_milestone("node_2_1577111741924", "Enter Zip Code")
    milestone_analysis.add_node_to_milestone("node_24_1591025731656", "Schedule time")
    ...
    data = json.loads(json.dumps(result, indent=4, sort_keys=True))
